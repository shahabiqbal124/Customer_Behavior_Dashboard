...
Key fields: Customer ID, Purchase Amount, Subscription Status, Product Details, Discounts, Age Group.
Processed and analyzed using Python (Pandas).
...
**Gamma:** Professional PPT reports
**Libraries:** Pandas
...
Revenue comparison: Subscriber vs. Non-Subscriber 💰
Top discounted products & purchase percentages 🔖
